...
func(f* Files) UploadMultipart(rw http.ResponseWriter, r *http.Request) {
	...
	if idErr != nil {
		f.log.Error("Bad request, expected integer id")
	...
	if err != nil {
		f.log.Error("Bad request, expected file header or file")
		http.Error(rw, "Expected file header or file", http.StatusBadRequest)
		return
	}

	f.saveFile(r.FormValue("id"), multipartHeader.Filename, rw, file)
